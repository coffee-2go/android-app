...
public class ShopAndTimeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_and_time);
        initComponents();
        ...
        confirm_button.setOnClickListener(view -> {
            Toast.makeText(ShopAndTimeActivity.this, "Confirmed " + shopName.getText() + " at " + time.getText(),
                    Toast.LENGTH_LONG).show();
